...
static void
get_text_value(const Item aElement, zorba::String& aValue)
{
...
void
CClientMimeHandler::set_encoding(BODY* aBody, zorba::String& aEncoding)
{
...
bool
CClientMimeHandler::set_content_type_value(BODY* aBody, zorba::String& aValue)
{
  bool          lRes = true;
